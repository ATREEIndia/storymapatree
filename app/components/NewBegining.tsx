...
const NewBegining = () => {
    return (
        <div className='flex flex-col gap-5 p-5 '>
            ...
            <div className="min-h-[50vh] bg-[url('/new-begining-top.png')] bg-cover bg-centre bg-no-repeat flex items-center ">

                <ul className=" px-4  mb-4 space-y-2 lg:w-1/2">
            ...
            <div className="min-h-[50vh] py-20  bg-[url('/new-begining-bottom.png')] bg-cover bg-centre bg-no-repeat flex  items-center relative ">
            ...
            <div className="flex  flex-col w-full gap-5">
                <div className="w-full flex flex-row-reverse">
                   ...
                   <div className="flex flex-col gap-2 lg:w-1/2">
                    ...
                    <ul className=" px-4  mb-4 space-y-2 text-gray-900">
                ...
                <div className="text-gray-100 w-full text-center"> Restoration, after all, is not an endpoint but a continuous process that requires upkeep and shared responsibility.</div>
